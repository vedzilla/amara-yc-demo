...
// Official Slack mark (4-colour). viewBox 122.8 — partner logo for the integration.
export const SlackLogo: React.FC<{ size?: number }> = ({ size = 26 }) => (
  <svg width={size} height={size} viewBox="0 0 122.8 122.8" aria-label="Slack">
...
// Gmail envelope mark (Google material). viewBox 48.
export const GmailLogo: React.FC<{ size?: number }> = ({ size = 26 }) => (
